...
public class WebhookExecutorFactory {
    ...
    public static class Builder {
        ...
        public Builder throwable(Throwable throwable, String basePackageName) {
        ...
        public void execute() {
            ...
            requestBody.addGlobalInfo(new GlobalInfo(webhookProductEnum, this.throwable, this.basePackageName, this.webhookExtraInfo));
